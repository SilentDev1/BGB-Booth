...
def restore_conf():
    ...
    if not os.path.exists(conf_filename):
        ...
        default_conf = '''[main]
emailsubject = Your Postcard from the BGB Photobooth
emailmsg = Here's your picture from the BGB photobooth!
...
''' % install_dir
    ...
    emailSubject = conf.get('main', 'emailSubject') # "Your Postcard from the BGB Photobooth"
    emailMsg = conf.get('main', 'emailMsg') # "Here's your picture from the BGB photobooth!"
